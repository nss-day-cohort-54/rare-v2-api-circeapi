...
from rareapi.models import Photo, Author
...
class PhotoView(ViewSet):
    ...
    def create(self, request):
        ...
        format, imgstr = request.data["author_image"].split(';base64,')
        ext = format.split('/')[-1]
        data = ContentFile(base64.b64decode(imgstr), name=f'{request.data["author_id"]}-{uuid.uuid4()}.{ext}')
